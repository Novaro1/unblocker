...
const commands = [
  ...
  },
  {
    ...
    options: [
      {
        name: "filter",
        description: "Your school content filter",
        type: ApplicationCommandOptionType.String,
        required: true,
        choices: [
  ...
  },
  {
    ...
    description: "Legacy command — /findlink now uses the Veil Filter API automatically [Admin]",
    options: [
      {
        name: "key",
        description: "No longer required — kept for backwards compatibility",
        type: ApplicationCommandOptionType.String,
        required: false,
      },
    ],
